...
public class MatchesRecord extends UpdatableRecordImpl<MatchesRecord> implements Record5<Long, Hero, Hero, Result, LocalDate> {
    ...
    @Override
    public Row5<Long, Hero, Hero, Result, LocalDate> valuesRow() {
    ...
    @Override
    public MatchesRecord values(Long value1, Hero value2, Hero value3, Result value4, LocalDate value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MatchesRecord(Long id, Hero myHero, Hero opponentHero, Result result, LocalDate playedOn) {
        super(Matches.MATCHES);
